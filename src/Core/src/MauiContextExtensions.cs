...
namespace Microsoft.Maui
{
	internal static partial class MauiContextExtensions
	{
		...
		public static void InitializeApplicationScope(this IMauiContext mauiContext, NativeApplication platformApplication)
		{
			var provider = mauiContext.Services.GetRequiredService<PlatformApplicationProvider>();
			provider.SetApplication(platformApplication);
		}
